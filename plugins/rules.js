...
let handler = async (m, { conn }) => await conn.send2ButtonLoc(m.chat, await (await fetch(image)).buffer(), `
...
*10.* _Instagram_ : https://instagram.com/fahril.ar.73
...
`.trim(), footer, 'thanks', '.tqto', 'menu', '.menu', m)
handler.help = ['rules']
handler.tags = ['info', 'main']
handler.command = /^(rules|syarat|kebijakan)$/i
